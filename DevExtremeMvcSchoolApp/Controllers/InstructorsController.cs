...
namespace DevExtremeMvcSchoolApp.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Surname")] Instructor instructor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Surname")] Instructor instructor)
        {
            if (ModelState.IsValid)
            {
